...
function Input_Digit(digit) {
    ...
    //we are cheking to see if Wait_Second_Operator is true and set Display_Value to the key that was clicked. 
    if (Wait_Second_Operand === true) {
        Calculator.Display_Value = digit;
        Calculator.Wait_Second_Operand = false;
    } else {
        //this overwrites Display_Value if the urrent value is 0 otherwise it adds onto it
...
function Handle_Operator(Next_Operator) {
    ...
    //if operator exists, property lookip is performed for the operator
